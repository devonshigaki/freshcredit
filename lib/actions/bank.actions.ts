...
//     const totalBanks = accountsResponse.length;
//     const totalCurrentBalance = accountsResponse.reduce((total, account) => {
//       return total + account.currentBalance;
//     }, 0);

//     return parseStringify({ data: accountsResponse, totalBanks, totalCurrentBalance });
//   } catch (error) {
